...
DEFAULT_TABLE = "InfiniteDiscs"

INFINITE_DISCS_SCHEMA = [
    ...
    bigquery.SchemaField("AdditionalInputTitle", "STRING"),
    bigquery.SchemaField("ModelLink", "STRING"),
    bigquery.SchemaField("StockWeight", "INT64"),
    bigquery.SchemaField("AvailableStock", "INT64"),
    bigquery.SchemaField("ColorName", "STRING"),
    bigquery.SchemaField("StockPrice", "FLOAT64"),
    bigquery.SchemaField("StockImage", "STRING"),
    bigquery.SchemaField("ModelDescription", "STRING"),
